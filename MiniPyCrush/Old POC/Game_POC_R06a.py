...
class MTri():
    def __init__(self, center_x, center_y, change_x, change_y, friendly):
        ...
        self.tri_sprite.change_y = change_y
    ...
    def update(self, delta_time):       
        # Start the shape to the right
        # self.tri_sprite.center_x += self.tri_sprite.change_x
        # self.tri_sprite.center_y += self.tri_sprite.change_y
        # Gravity from the physics engine
        self.tri_sprite.physics_engine = arcade.PhysicsEnginePlatformer(self.tri_sprite,
                                                             self.tri_sprite.floors_list,
                                                             gravity_constant=GRAVITY)
